...
public class OtpService {
    ...
    public Boolean verifyOtpCode(String otpCode, VerifyRequest verifyRequest) {
        System.out.println(verifyRequest);
        System.out.println(otpCode);
        OtpTemplate otpTemplate = otpTemplateRepostory.getReferenceById(Long.valueOf(otpCode));
